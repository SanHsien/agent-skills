...
> **This is the Windows-first maintenance fork of [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills)**, under the MIT license with full git history. See [`FORK.md`](FORK.md) for what differs and [`docs/UPSTREAM.md`](docs/UPSTREAM.md) for the sync strategy. This file mirrors the upstream README verbatim (fork point 1c760d643497e9da289300e5eb2f5aca861503f7).
